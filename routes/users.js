...
const { ensureAdmin, checkUserOrAdmin } = require('../middleware/auth');
 ...
 * 
 * Route for applications which can either be submitted for a user by an admin OR by the user themselves.
 * 
 * Invalid job id returns 400 error.
 * 
 * Authorization required: login OR admin
 * 
*/
